...
%>
				<div class="input-group">
					<span class="input-group">
                    <input style="width:150px;" class="btn-meuEspaco-azul corlogoGlobal fcorbrancoGlobal" type="submit" name="submit_cancel" value="<fmt:message key="jsp.mydspace.perform-task.later.button"/>" />
                    </span>
                    <span class="form-control">
                ...
                <div class="input-group">
					<span class="input-group">
                    <input style="width:150px;" class="btn-meuEspaco-cinza corFontepretaGlobal" type="submit" name="submit_pool" value="<fmt:message key="jsp.mydspace.perform-task.return.button"/>" />
                    </span>
                    <span class="form-control">
