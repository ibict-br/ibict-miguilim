	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
		    <form action="<%= request.getContextPath() %>/mydspace" method="post">
                ...
                <input class="btn btn-secondary corlogoGlobal" type="submit" name="submit_new" value="<fmt:message key="jsp.mydspace.main.start.button"/>" />
                <input class="btn btn-secondary corlogoGlobal" type="submit" name="submit_own" value="<fmt:message key="jsp.mydspace.main.view.button"/>" />
		    </form>
...
<%
    ...
    {
%>
    <h3 class="classe_negrito"><fmt:message key="jsp.mydspace.main.heading2"/></h3>
...
%>
                ...
                <td headers="t3" class="<%= row %>RowOddCol"><%= owned.get(i).getCollection().getName() %>Teste</td>
                ...
                <td headers="t5" class="<%= row %>RowEvenCol">
                     <form action="<%= request.getContextPath() %>/mydspace" method="post">
                        ...
                        <input class="btn btn-secondary" type="submit" name="submit_return" value="<fmt:message key="jsp.mydspace.main.return.button"/>" />
                     </form> 
                </td>
        </tr>
<%
...
<%
    ...
    {
%>
    <h3 class="classe_negrito"><fmt:message key="jsp.mydspace.main.heading3"/></h3>
...
%>
                    ...
                    <td class="<%= row %>RowOddCol">
                        <form action="<%= request.getContextPath() %>/mydspace" method="post">
                            ...
                            <input class="btn btn-secondary" type="submit" name="submit_claim" value="<fmt:message key="jsp.mydspace.main.take.button"/>" />
                        </form> 
                    </td>
        </tr>
<%
...
%>
    ...
    <h3 class="classe_negrito"><fmt:message key="jsp.mydspace.main.heading4"/></h3>
        ...
        <tr>
            <td class="<%= row %>RowOddCol">
                <form action="<%= request.getContextPath() %>/workspace" method="post">
                    ...
                    <input class="btn btn-secondary corlogoGlobal" type="submit" name="submit_open" value="<fmt:message key="jsp.mydspace.general.open" />"/>
                </form>
            </td>
            ...
            <td headers="t13" class="<%= row %>RowOddCol">
                <form action="<%= request.getContextPath() %>/mydspace" method="post">
                    <input type="hidden" name="step" value="<%= MyDSpaceServlet.MAIN_PAGE %>"/>
                    <input type="hidden" name="workspace_id" value="<%= workspaceItems.get(i).getID() %>"/>
                    <input class="btn btn-secondary corVermelhoGlobal" type="submit" name="submit_delete" value="<fmt:message key="jsp.mydspace.general.remove" />"/>
                </form> 
            </td>
        </tr>
<%
        ...
        <tr>
            <td class="<%= row %>RowOddCol">
                <form action="<%= request.getContextPath() %>/workspace" method="post">
                    ...
                    <input class="btn btn-secondary" type="submit" name="submit_open" value="<fmt:message key="jsp.mydspace.general.open" />"/>
                </form>
            </td>
            ...
            <td class="<%= row %>RowOddCol">
                <form action="<%= request.getContextPath() %>/mydspace" method="post">
                    <input type="hidden" name="step" value="<%= MyDSpaceServlet.MAIN_PAGE %>"/>
                    <input type="hidden" name="workspace_id" value="<%= supervisedItems.get(i).getID() %>"/>
                    <input class="btn btn-secondary" type="submit" name="submit_delete" value="<fmt:message key="jsp.mydspace.general.remove" />"/>
                </form>  
            </td>
        </tr>
<%
...
<%
    ...
    if (workflowItems.size() > 0)
    {
        ...
        String row = "even";
%>
    <h3 class="classe_negrito"><fmt:message key="jsp.mydspace.main.heading5"/></h3>
