...
%>
       ...
       <div class="navbar-header">
         ...
         <a class="navbar-brand" href="<%= request.getContextPath() %>/"><img height="45" src="<%= request.getContextPath() %>/image/ibict.png" alt="Ibict" /></a>
       </div>
       <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
         <ul class="nav menu-letra-vermelha">
          ...
          <li class="dropdown">
             <a href="#" class="dropdown-toggle" data-toggle="dropdown"><fmt:message key="jsp.layout.navbar-admin.contents"/></a>
           ...
           <li class="dropdown">
             <a href="#" class="dropdown-toggle" data-toggle="dropdown"><fmt:message key="jsp.layout.navbar-admin.accesscontrol"/></a>
             <ul class="dropdown-menu fundo-laranja">
		  ...
		  <li class="dropdown">
             <a href="#" class="dropdown-toggle" data-toggle="dropdown"><fmt:message key="jsp.layout.navbar-admin.settings"/></a>
             <ul class="dropdown-menu fundo-laranja">
       ...
       <div class="nav navbar-nav navbar-right menu-letra-vermelha">
		<ul class="nav navbar-nav navbar-right menu-letra-vermelha">
         <li class="dropdown">
