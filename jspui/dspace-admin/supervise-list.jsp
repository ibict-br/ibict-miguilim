...
<form method="post" action="">
    <input class="btn btn-secondary" type="submit" name="submit_base" value="<fmt:message key="jsp.dspace-admin.supervise-list.back.button"/>"/>
    <input class="btn btn-secondary" type="submit" name="submit_add" value="<fmt:message key="jsp.dspace-admin.supervise-list.add.button"/>"/>
</form>
</div>
</dspace:layout>
