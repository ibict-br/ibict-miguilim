...
<form method="post" action="">
    <div class="row">
    	<input class="btn btn-primary col-md-6 corlogoGlobal" type="submit" name="submit_add" value="<fmt:message key="jsp.dspace-admin.supervise-main.add.button"/>"/>
    </div>
    <div class="row">
    	<input class="btn btn-info col-md-6" type="submit" name="submit_view" value="<fmt:message key="jsp.dspace-admin.supervise-main.view.button"/>"/>
    </div>
    <div class="row">    
    	<input class="btn btn-info col-md-6 corVermelhoGlobal" type="submit" name="submit_clean" value="<fmt:message key="jsp.dspace-admin.supervise-main.clean.button"/>"/>
    </div>
</form>
<div align="center" />
