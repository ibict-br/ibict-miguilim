...
%>
        ...
        <input type="text" name="starts_with" class="form-control espGlobalTopBorder" size="4" maxlength="4"/>
<%
	}
...
%>
		...
		<input type="text" name="starts_with" class="form-control espGlobalTopBorder" />
		<input type="submit" class="btn btn-default" value="<fmt:message key="browse.nav.go"/>" />
<%
	}
%>
...
%>
		...
		<input type="submit" class="btn-customizado" name="submit_browse" value="<fmt:message key="jsp.general.update"/>"/>
	</form>
	</div>
...
<div class="col-md-8 offset-md-2">
	...
	<div class="panel-heading-customizado text-center">
...
%>
	...
	<div class="panel-footer-customizado text-center">
		<fmt:message key="browse.single.range">
			<fmt:param value="<%= Integer.toString(bi.getStart()) %>"/>
			<fmt:param value="<%= Integer.toString(bi.getFinish()) %>"/>
			<fmt:param value="<%= Integer.toString(bi.getTotal()) %>"/>
