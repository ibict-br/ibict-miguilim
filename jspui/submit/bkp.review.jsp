...
%>
        ...
        <div class="col-md-6 pull-right btn-group">
			<input class="btn btn-secondary col-md-4" type="submit" name="<%=AbstractProcessingStep.PREVIOUS_BUTTON%>" 
				   value="<fmt:message key="jsp.submit.review.button.previous"/>" />
          	<input class="btn btn-secondary col-md-4" type="submit" name="<%=AbstractProcessingStep.CANCEL_BUTTON%>" 
				   value="<fmt:message key="jsp.submit.review.button.cancelsave"/>" />
          	<input class="btn btn-success col-md-4" type="submit" name="<%=AbstractProcessingStep.NEXT_BUTTON%>" 
