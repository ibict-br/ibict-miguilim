...
<dspace:layout style="submission"
    ...
    <form action="<%= request.getContextPath() %>/submit" method="post" onkeydown="return disableEnterKey(event);">
		...
		<div class="pull-right">
			<input class="btn btn-secondary" type="submit" name="submit_back" value="<fmt:message key="jsp.submit.cancel.continue.button"/>" />
			<input class="btn btn-danger" type="submit" name="submit_remove" value="<fmt:message key="jsp.submit.cancel.remove.button"/>" />
			<input class="btn btn-secondary" type="submit" name="submit_keep" value="<fmt:message key="jsp.submit.cancel.save.button"/>" />
        </div>
    </form>
