        ...
        <%= SubmissionController.getSubmissionParameters(context, request) %>
				<%  //if not first step, show "Previous" button
					...
					<div class="row">
						<div class="col-md-6 pull-right btn-group">
							<input class="btn btn-default col-md-4 col-md-4 fcorbrancoGlobal" type="submit" name="<%=AbstractProcessingStep.PREVIOUS_BUTTON%>" value="<fmt:message key="jsp.submit.general.previous"/>" />
							<input class="btn btn-default col-md-4 corLaranjaGlobal corFontelogoGlobal" type="submit" name="<%=AbstractProcessingStep.CANCEL_BUTTON%>" value="<fmt:message key="jsp.submit.general.cancel-or-save.button"/>" />
							<input class="btn btn-primary col-md-4 corlogoGlobal" type="submit" name="<%=AbstractProcessingStep.NEXT_BUTTON%>" value="<fmt:message key="jsp.submit.general.next"/>" />
						</div>
					</div>		
    			...
    			<div class="row">
					<div class="col-md-4 pull-right btn-group">
						<input class="btn btn-default col-md-6 corLaranjaGlobal corFontelogoGlobal" type="submit" name="<%=AbstractProcessingStep.CANCEL_BUTTON%>" value="<fmt:message key="jsp.submit.general.cancel-or-save.button"/>" />
						<input class="btn btn-primary col-md-6 corlogoGlobal" type="submit" name="<%=AbstractProcessingStep.NEXT_BUTTON%>" value="<fmt:message key="jsp.submit.general.next"/>" />
					</div>
				</div>		
    			<%  }  %>
    </form>
