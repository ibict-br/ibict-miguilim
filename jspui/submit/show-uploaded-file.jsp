...
<%-- HACK: Center used to align table; CSS and align="center" ignored by some browsers --%>
				...
				<%  //if not first step, show "Previous" button
					...
					<div class="col-md-6 pull-right btn-group">
						<input class="btn btn-default col-md-4 fcorbrancoGlobal" type="submit" name="<%=AbstractProcessingStep.PREVIOUS_BUTTON%>" value="<fmt:message key="jsp.submit.general.previous"/>" />
