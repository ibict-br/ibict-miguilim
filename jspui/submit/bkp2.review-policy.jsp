...
<div class="col-md-10">
	<div class="row">
		<span class="col-md-4"><fmt:message key="jsp.submit.access.private_setting.heading"/></span> 
		<span
			class=" col-md-8"> <% if(isDiscoverable) { %>
			<fmt:message
...
<div class="col-md-10">
		<% if(advanced) { %>
			<div class="row">
				<span class="col-md-10"><fmt:message key="jsp.submit.access.plist.heading"/></span>
			</div>
		...
		<% } else { %>
		    ...
		    if(startDate!=null) { %>
			<div class="row">
			<span class="col-md-4"><fmt:message key="jsp.submit.access.embargo_setting.heading"/></span>
			<span
