...
%>            
					...
					<div class="input-group espGlobalesq7">
					<label for="tcollection" class="input-group">
						<p id="espaço-colecao"><fmt:message key="jsp.submit.select-collection.collection"/></p>
					</label>
          <dspace:selectcollection klass="col-md-6 form-control" id="tcollection" collection="-1" name="collection"/>
					</div><br/>
            <%-- Hidden fields needed for SubmissionController servlet to know which step is next--%>
            <%= SubmissionController.getSubmissionParameters(context, request) %>

				<div class="row">
					<div class="col-md-4 mb-5 btn-group espGlobalesq15Invert">
						<input class="btn btn-light col-md-6" type="submit" name="<%=AbstractProcessingStep.CANCEL_BUTTON%>" value="<fmt:message key="jsp.submit.select-collection.cancel"/>" />
