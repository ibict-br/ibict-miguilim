      ...
      throws java.io.IOException
    {
      ...
      for (int i = 0; i < fieldCount; i++)
      {
         ...
         sb.append("<div class=\"row col-md-12\"><div class=\"input-group col-md-10\"><div class=\"row\">")
			.append("<span class=\"input-group col-md-6\"><span class=\"input-group\">")
...
//          .append(">(No month)</option>");
         ...
         sb.append("</select></span>")
	            .append("<span class=\"input-group col-md-2\"><span class=\"input-group\">")
         ...
         sb.append("\" size=\"2\" maxlength=\"2\" value=\"")
                ...
                .append("\"/></span><span class=\"input-group col-md-4\"><span class=\"input-group\">")
      ...
      throws IOException
    {
      ...
      for (int j = 0; j < fieldCount; j++)
      {
         ...
         // do the dropdown box
         sb.append("<div class=\"row col-md-12\"><span class=\"input-group col-md-10\"><span class=\"input-group\"><select name=\"")
           .append(fieldName)
           .append("_qualifier");
         if (repeatable)
...
//            .append("_add\" value=\"Add More\"/> </td></tr>");
      ...
      throws java.io.IOException
    {
      ...
      sb.append("<span class=\"col-md-10\">")
    ...
    void doList(javax.servlet.jsp.JspWriter out, Item item,
            ...
            throws java.io.IOException
          {
            ...
            for (int i = 0; i < valueList.size(); i += 2)
            {
                   ...
                   // print input field
                   sb.append("<div class=\"input-group\"><span class=\"input-group\">");
...
%>
  ...
  <form action="<%= request.getContextPath() %>/submit#<%= si.getJumpToField()%>" method="post" name="edit_metadata" id="edit_metadata" onkeydown="return disableEnterKey(event);">
    ...
    <h1><br><br><br><br><br><br><br><fmt:message key="jsp.submit.edit-metadata.heading"/>
<%
...
<%  //if not first page & step, show "Previous" button
		...
		{ %>
			<div class="col-md-6 pull-right btn-group">
				<input class="btn btn-secondary col-md-4 fcorbrancoGlobal" type="submit" name="<%=AbstractProcessingStep.PREVIOUS_BUTTON%>" value="<fmt:message key="jsp.submit.edit-metadata.previous"/>" />
				<input class="btn btn-secondary col-md-4 corLaranjaGlobal corFontelogoGlobal" type="submit" name="<%=AbstractProcessingStep.CANCEL_BUTTON%>" value="<fmt:message key="jsp.submit.edit-metadata.cancelsave"/>"/>
				<input class="btn btn-primary col-md-4 corlogoGlobal" type="submit" name="<%=AbstractProcessingStep.NEXT_BUTTON%>" value="<fmt:message key="jsp.submit.edit-metadata.next"/>"/>
    <%  } else { %>
    		<div class="col-md-4 pull-right btn-group">
                <input class="btn btn-secondary col-md-6 fcorbrancoGlobal" type="submit" name="<%=AbstractProcessingStep.CANCEL_BUTTON%>" value="<fmt:message key="jsp.submit.edit-metadata.cancelsave"/>"/>
				<input class="btn btn-primary col-md-6 corlogoGlobal" type="submit" name="<%=AbstractProcessingStep.NEXT_BUTTON%>" value="<fmt:message key="jsp.submit.edit-metadata.next"/>"/>
    <%  }  %>
    		</div><br/>
</div>    		
    </form>
