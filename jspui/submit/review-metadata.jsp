...
<%
    ...
    int qtdePages = Integer.parseInt((String) request.getParameter("maxPageNum"));
...
<div class="col-md-9">
    <%
        ...
        /* se estiver na ultima pagina de bloco de metadados para correcao exibe o termometro */
        if (pageNum == qtdePages) {
    %>
...
<div class="col-md-3">
    <input class="btn btn-secondary" type="submit" name="submit_jump_<%=stepJump%>"
