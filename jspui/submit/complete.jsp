...
<dspace:layout style="submission" locbar="off" navbar="off" titlekey="jsp.submit.complete.title">
	...
	<p class="alert alert-info-customizado"><fmt:message key="jsp.submit.complete.info"/></p> 
    ...
    <form action="<%= request.getContextPath() %>/submit" method="post" onkeydown="return disableEnterKey(event);">
	    ...
	    <input class="btn btn-success pull-right corlogoGlobal" type="submit" name="submit" value="<fmt:message key="jsp.submit.complete.again"/>"/>
    </form>
