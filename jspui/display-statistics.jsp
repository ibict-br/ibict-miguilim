	...
	<!-- 
	 ...
	 <c:if test="${not empty statsMonthlyVisits and not empty statsMonthlyVisits.colLabels}">
		...
		<div class="panel panel-primary">
			...
			<div class="panel-heading-estatisticas">
		...
		<!-- 
		 ...
		 -->
		 <!--<c:out value="${statsCountryVisits.colLabels}" />-->
		...
		<!--<div>
			<a class="btn btn-primary corlogoGlobal" href="javascript:history.back()"><fmt:message key="jsp.statistics.button.return"></fmt:message></a></a>
		</div>-->
