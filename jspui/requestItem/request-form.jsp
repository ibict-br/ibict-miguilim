        ...
        <div class="form-group">
         ...
         <div class="col-md-10">
	        <div class="input-group"> 
	         <span class="input-group"><input type="radio" name="allfiles" value="true" <%=allfiles?"checked":""%> /></span>
	         <span class="form-control"><fmt:message key="jsp.request.item.request-form.yes"/></span>
	        </div>
	        <div class="input-group">
	         <span class="input-group"><input type="radio" name="allfiles" value="false" <%=allfiles?"":"checked"%> /></span>
