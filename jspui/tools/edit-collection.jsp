...
<%  } else { %>
                    ...
                    <input class="col-md-12 btn btn-success corlogoGlobal" type="submit" name="submit_set_logo" value="<fmt:message key="jsp.tools.edit-collection.form.button.set-logo"/>" />
<%  } %>
				</div>
			</div>	
		</div>
...
<%  } else { %>
                    <input class="btn btn-default col-md-6 corlogoGlobal fcorbrancoGlobal"  type="submit" name="submit_submitters_edit" value="<fmt:message key="jsp.tools.edit-collection.form.button.edit"/>" />
                    <input class="btn btn-danger col-md-9"  type="submit" name="submit_submitters_delete" value="<fmt:message key="jsp.tools.edit-collection.form.button.delete"/>" />
<%  } %>
				</span>
			</div><br/>                
<%  } %>            
...
<%
    ...
    for (int i = 0; i<3; i++) { %>
    		<div class="row">  
                ...
                <span class="col-md-6 btn-group">
<%      if (wfGroups[i] == null) { %>
                    <input class="btn btn-success col-md-9 corlogoGlobal fcorbrancoGlobal" type="submit" name="submit_wf_create_<%= i + 1 %>" value="<fmt:message key="jsp.tools.edit-collection.form.button.create"/>" />
<%      } else { %>
...
<%-- ===========================================================
     ...
     =========================================================== --%>
                ...
                <span class="col-md-6 btn-group">
<%  if (template == null) {%>
                    <input class="btn btn-success col-md-12 corlogoGlobal" type="submit" name="submit_create_template" value="<fmt:message key="jsp.tools.edit-collection.form.button.create"/>" />
...
<%-- ===========================================================
     ...
     =========================================================== --%>
     		<div class="row">
                ...
                <span class="col-md-6 btn-group">
                    <input class="btn btn-success col-md-12 corlogoGlobal" type="submit" name="submit_authorization_edit" value="<fmt:message key="jsp.tools.edit-collection.form.button.edit"/>" />
                </span>
        	</div><br/>    
<%  } %>
...
<%-- ===========================================================
     ...
     =========================================================== --%>
            <div class="row">
                ...
                <span  class="col-md-6 btn-group">
                    <input class="btn btn-success col-md-12 corlogoGlobal" type="submit" name="submit_curate_collection" value="<fmt:message key="jsp.tools.edit-collection.form.button.curate"/>" />
				</span>
			</div>
<%  } %>
   ...
   <div class="panel panel-default">
		...
		<div class="panel-body">
			...
			--%>
                ...
                <div>	
                <label for="source_normal"><fmt:message key="jsp.tools.edit-collection.form.label16"/></label>
                <div>
				...
				<div>	
                <label for="harvest_level"><fmt:message key="jsp.tools.edit-collection.form.label22"/></label>
                <div>
...
%>
                        ...
                        <input class="btn btn-success col-md-6 corlogoGlobal" type="submit" name="submit" value="<fmt:message key="jsp.tools.edit-collection.form.button.update"/>" />
<% 
    }
%>
                        <input type="hidden" name="community_id" value="<%= community.getID() %>" />
