...
%>
    ...
    <% if(bDelete) { %>
              <form class="col-md-4" method="post" action="">
                ...
                <input class="col-md-12 btn btn-secundary corlogoGlobal fcorbrancoGlobal" type="submit" name="submit_delete" value="<fmt:message key="jsp.tools.edit-community.button.delete"/>" />
              </form>
    <% } %>
<%
    }
...
<%  } else { %>
                    <input class="col-md-12 btn btn-secundary corlogoGlobal fcorbrancoGlobal" type="submit" name="submit_set_logo" value="<fmt:message key="jsp.tools.edit-community.form.button.set-logo"/>" />
<%  } %>
                    </div>
			</div>
...
<% if(bAdminCreateGroup || (admins != null && bAdminRemoveGroup)) { %>
 <%-- ===========================================================
     ...
     =========================================================== --%>
			...
			%>
                    <input class="col-md-12 btn btn-secundary corlogoGlobal fcorbrancoGlobal" type="submit" name="submit_admins_create" value="<fmt:message key="jsp.tools.edit-community.form.button.create"/>" />
			<%  	}
				} 
				else 
				{ 
...
<%-- ===========================================================
     ...
     =========================================================== --%>
            <div class="row">
                ...
                <span class="col-md-6 btn-group">
                    <input class="col-md-12 btn btn-secundary corlogoGlobal fcorbrancoGlobal" type="submit" name="submit_authorization_edit" value="<fmt:message key="jsp.tools.edit-community.form.button.edit"/>" />
                </span>
            </div>   
    <% }
...
<%-- ===========================================================
     ...
     =========================================================== --%>
            <div class="row">
                ...
                <span class="col-md-6">
                    <input class="col-md-12 btn btn-secundary corlogoGlobal fcorbrancoGlobal" type="submit" name="submit_curate_community" value="<fmt:message key="jsp.tools.edit-community.form.button.curate"/>" />
                </span>
            </div>   
    <% } %>
	</div>
...
%>
                        ...
                        <input class="col-md-6 btn btn-success corlogoGlobal" type="submit" name="submit" value="<fmt:message key="jsp.tools.edit-community.form.button.create"/>" />
                        
                        <input type="hidden" name="parent_community_id" value="<%= parentID %>" />
                        <input type="hidden" name="action" value="<%= EditCommunitiesServlet.CONFIRM_EDIT_COMMUNITY %>" />
                        <input class="col-md-6 btn btn-warning corlogoGlobal" type="submit" name="submit_cancel" value="<fmt:message key="jsp.tools.edit-community.form.button.cancel"/>" />
<%
    }
    else
    {
%>
                        ...
                        <input class="col-md-6 btn btn-success corlogoGlobal" type="submit" name="submit" value="<fmt:message key="jsp.tools.edit-community.form.button.update"/>" />

                        <input type="hidden" name="community_id" value="<%= community.getID() %>" />
                        <input type="hidden" name="action" value="<%= EditCommunitiesServlet.CONFIRM_EDIT_COMMUNITY %>" />
                        <input class="col-md-6 btn btn-secundary corLaranjaGlobal fcorbrancoGlobal" type="submit" name="submit_cancel" value="<fmt:message key="jsp.tools.edit-community.form.button.cancel"/>" />
<%
    }
%>
            </div>
