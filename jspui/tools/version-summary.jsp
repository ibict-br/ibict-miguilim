 ...
 <form action="<%= request.getContextPath() %>/tools/version" method="post">
        ...
        <p><fmt:message key="jsp.dspace-admin.version-summary.text3"><fmt:param><%= itemID%></fmt:param></fmt:message></p>
                   ...
                   <div class="form-group">
                    ...
                    <input class="btn btn-secondary" type="submit" name="submit_version" value="<fmt:message key="jsp.version.version-summary.submit_version"/>" />
                    <%-- <input type="submit" name="cancel" value="Cancel"> --%>
                    <input class="btn btn-secondary" type="submit" name="submit_cancel" value="<fmt:message key="jsp.dspace-admin.general.cancel"/>" />
</form>
</dspace:layout>
