...
<dspace:layout style="submission" titlekey="jsp.tools.itemmap-browse.title">
	...
	<div class="btn-group">		
		<input type="hidden" name="action" value="<%=browsetype%>" />
                <% if (browsetype.equals("Add")) { %>
                        <input class="btn btn-secondary" type="submit" value="<fmt:message key="jsp.tools.general.add"/>" />
                <% } else if (browsetype.equals("Remove")) { %>
                        <input class="btn btn-danger" type="submit" value="<fmt:message key="jsp.tools.general.remove"/>" />
                <% } %>
        
        <input class="btn btn-secondary" type="submit" name="cancel" value="<fmt:message key="jsp.tools.general.cancel"/>" />
	</div>        
...
<% if (pageResult > 1) { %>			
	...
	<form method="post" class="standard10" action="">
        ...
        <input class="btn btn-secondary col-md-6" type="submit" value="<fmt:message key="jsp.tools.itemmap-browse.previous.button"/>"/> 
    </form>
