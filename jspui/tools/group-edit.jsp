...
<dspace:layout style="submission" titlekey="jsp.tools.group-edit.title"
	...
	<br/>
    <div class="row"><input class="btn btn-success col-md-2 col-md-offset-5 corlogoGlobal" type="submit" name="submit_group_update" value="<fmt:message key="jsp.tools.group-edit.update.button"/>" onclick="javascript:finishEPerson();finishGroups();"/></div>
   </form>
</dspace:layout>
