...
<dspace:layout style="submission" titlekey="jsp.tools.edit-item-form.title"
    ...
    <p class="corlogoGlobal fcorbrancoGlobal fontdefault fontdefaultsize fontdefaultpadding"><fmt:message key="jsp.tools.edit-item-form.note"/></p>
...
%>                     
					<form method="post" action="<%= request.getContextPath() %>/tools/edit-item">
						...
						<input class="btn btn-default col-md-12 corlogoGlobal fcorbrancoGlobal" type="submit" name="submit" value="<fmt:message key="jsp.tools.edit-item-form.move-item.button"/>"/>
                    </form>
<%
  }
%>
...
%>
                    <form method="post" action="<%= request.getContextPath() %>/tools/edit-item">
                        ...
                        <input class="btn btn-default col-md-12 corlogoGlobal fcorbrancoGlobal" type="submit" name="submit" value="<fmt:message key="jsp.tools.edit-item-form.privating-w-confirm.button"/>"/>
                    </form>
<%
    }
...
%>
                    <form method="post" action="<%= request.getContextPath() %>/tools/edit-item">
                        ...
                        <input class="btn btn-default col-md-12 corlogoGlobal fcorbrancoGlobal" type="submit" name="submit" value="<fmt:message key="jsp.tools.edit-item-form.publicize.button"/>"/>
                    </form>
<%
    }
%>
	...
	<%-- ===========================================================
     ...
     =========================================================== --%>
							<form method="post"
								...
								<input class="btn btn-default col-md-12 corlogoGlobal fcorbrancoGlobal" type="submit"
 ...
 %>
            <tr>
                ...
                <td headers="t5" class="<%= row %>RowEvenCol">
                    ...
                    <button class="btn btn-danger corTrans" name="submit_remove_<%= key %>_<%= sequenceNumber %>" value="<fmt:message key="jsp.tools.general.remove"/>">
...
<%  } %>
        ...
        format field.</p> --%>
                <p class="corlogoGlobal fcorbrancoGlobal fontdefault fontdefaultsize fontdefaultpadding"><fmt:message key="jsp.tools.edit-item-form.note3"/></p>
	<div class="table-responsive">
...
%>
                <td headers="t18" class="<%= row %>RowEvenCol">
                                        ...
                                        <% if (bRemoveBits) { %>
                                        <button class="btn btn-danger corTrans" name="submit_delete_bitstream_<%= key %>" value="<fmt:message key="jsp.tools.general.remove"/>">
                                        	<span class="glyphicon glyphicon-trash"></span>
                                        </button>
                                        <% } %>
                </td>
...
%>
	...
	<div class="btn-group col-md-12">
                <%
					if (bCreateBits) {
                %>                
					<input class="btn btn-success corlogoGlobal col-md-2" type="submit" name="submit_addbitstream" value="<fmt:message key="jsp.tools.edit-item-form.addbit.button"/>"/>
                <%  }
        ...
        <input type="hidden" name="action" value="<%= EditItemServlet.UPDATE_ITEM %>"/>
                        ...
                        <input class="btn btn-primary corlogoGlobal pull-right col-md-3" type="submit" name="submit" value="<fmt:message key="jsp.tools.general.update"/>" />
                        <%-- <input type="submit" name="submit_cancel" value="Cancel" /> --%>
						<input class="btn btn-default pull-right col-md-3 corlogoGlobal fcorbrancoGlobal" type="submit" name="submit_cancel" value="<fmt:message key="jsp.tools.general.cancel"/>" />
					</div>
    </form>
</dspace:layout>
