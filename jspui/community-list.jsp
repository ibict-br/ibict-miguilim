...
<%!
    		...
    		Map collectionMap, Map subcommunityMap) throws ItemCountException, IOException, SQLException
    {
        ...
        out.println( "<li class=\"media well corbrancoGlobal\">" );
        ...
        out.println( "<div class=\"media-body\"><h4 class=\"media-heading\"><a class=\"fcorpretoGlobal espGlobalesq15 fontGlobal2\" href=\"" + request.getContextPath() + "/handle/" 
        ...
        if (cols != null && cols.size() > 0)
        {
            ...
            {
                out.println("<li class=\"media well corlogoGlobal\">");
                ...
                out.println("<div class=\"media-body\"><h4 class=\"media-heading\"><a class=\"fcorbrancoGlobal fontGlobalbranca\" href=\"" + request.getContextPath() + "/handle/" + cols.get(j).getHandle() + "\">" + cols.get(j).getName() +"</a>");
				if(ConfigurationManager.getBooleanProperty("webui.strengths.show"))
                {
...
<dspace:sidebar>
			...
			<div class="panel-body">
                <form method="post" action="<%=request.getContextPath()%>/dspace-admin/edit-communities">
					...
					<input class="css3button col-md-12" type="submit" name="submit" value="<fmt:message key="jsp.community-list.create.button"/>" />
                </form>
            </div>
</dspace:sidebar>
<%
...
%>
	<h1 class="espGlobalesq30 fontGlobal"><fmt:message key="jsp.community-list.title"/></h1>
	<p class="espGlobalesq30 fontGlobal"><fmt:message key="jsp.community-list.text1"/></p>
